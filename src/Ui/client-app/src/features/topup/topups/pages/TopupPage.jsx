        ...
        <div>
           ...
           <div className="border rounded mt-2 p-2 d-flex gap-2 align-items-center">
                ...
                <div className="d-flex flex-column gap-1 " style={{'font-size': '14px'}}>
                    <div className="d-flex gap-1 ">This QR code / transaction only supports banking transactions in <strong>Việt Nam</strong> 
                        <span>
                    ...
                    <div style={{'font-size': '13px', 'color': 'gray'}}>
                        If you want to try with international or third-party QR code types, please wait for the next update.      
                    </div>
                </div>
           </div>
              {/* Tabs content */}
                ...
                <div id="panel2" role="tabpanel">
                   <div>
                        <div className="d-flex gap-1 align-items-center mb-1">                       
                            ...
                            <span style={{fontSize:'16px', fontWeight:600}}>Test enviroment</span>
                        </div>
                        <textarea 
                        ...
                        style={{width:'100%',borderRadius:'8px', minHeight:'200px',maxHeight:'300px',fontSize:'14px'}}>
                        ...
                        <div className="d-flex justify-content-end gap-2">
                            ...
                            <button className="btn btn-primary btn-sm mt-2">Send Request</button>
                        </div>
                   </div>
                </div>
                )}
